...
class UDisCo(IBackendModel):
    def __init__(
        ...
        self.inc = nn.Conv1d(in_channels, 64, kernel_size=3, padding='same')
        ...
        self.outc = nn.Conv1d(64, 1, kernel_size=3, padding='same')
        self.control_conv = nn.Conv1d(1 + 1, 1, kernel_size=3, padding='same') if self.use_control else None
...
class UDisCoMedium(IBackendModel):
    def __init__(
            self,
            in_channels: int,
            linear: bool = False,
        ...
        self.down5 = Down(512, 512, dropout_p=dropout_p)
        factor = 2 if linear else 1
        self.down6 = Down(512, 1024 // factor, dropout_p=dropout_p)

        self.up1 = Up(1024, 512, linear, dropout_p=dropout_p)
        self.up2 = Up(1024, 512, linear, dropout_p=dropout_p)
        self.up3 = Up(1024, 512 // factor, linear, dropout_p=dropout_p)
        self.up4 = Up(512, 256 // factor, linear, dropout_p=dropout_p)
        self.up5 = Up(256, 128 // factor, linear, dropout_p=dropout_p)
        self.up6 = Up(128, 64, linear, dropout_p=dropout_p)
    ...
    @classmethod
    def from_config(cls, config: ExpConfig) -> 'UDisCoMedium':
        return cls(
            in_channels=config.model_dev.vocab_size + config.model_dev.n_epi,
            linear=config.model_dev.linear_upsample,
            dropout_p=config.model_dev.dropout_p,
...
class UDisCoSmall(IBackendModel):
    def __init__(
            self,
            in_channels: int,
            linear: bool = False,
        ...
        self.up1 = Up(1024, 512 // factor, linear, dropout_p=dropout_p)
        self.up2 = Up(512, 256 // factor, linear, dropout_p=dropout_p)
        self.up3 = Up(256, 128 // factor, linear, dropout_p=dropout_p)
        self.up4 = Up(128, 64, linear, dropout_p=dropout_p)
    ...
    @classmethod
    def from_config(cls, config: ExpConfig) -> 'UDisCoSmall':
        return cls(
            in_channels=config.model_dev.vocab_size + config.model_dev.n_epi,
            linear=config.model_dev.linear_upsample,
            dropout_p=config.model_dev.dropout_p,
